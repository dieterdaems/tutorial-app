...
export const ImportCard = ({
    ...
    const handleTableHeadSelectChange = (columnIndex: number, value: string | null) => {
    ...
    const progres = Object.values(selectedColumns).filter(Boolean).length;
        ...
        <div className="max-w-screen-2xl mx-auto w-full pb-10 -mt-24 lg:pl-10 lg:pr-10">
            <Card className="border-none drop-shadow-sm">
                <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <Button
                        disabled={progres < requiredOptions.length}
                        onClick={handleContinue}
                        size="sm"
                        className="w-full lg:w-auto"
                        >
                        Continue ({progres}/{requiredOptions.length})
                    </Button>
                    </div>
                </CardHeader>
                <CardContent>
